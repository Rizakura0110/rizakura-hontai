import type { FetchedMetadata, MetadataFetchResponse } from "../contracts";
import type { MetadataErrorCode } from "../core/metadata";
...
export type FetchMetadataDependencies = {
  ...
  readonly parse: (response: Response, finalUrl: string) => Promise<FetchedMetadata>;
...
async function readLimitedBody(response: Response): Promise<Uint8Array<ArrayBuffer> | null> {
...
export async function fetchMetadata(
  rawUrl: string,
  dependencies: FetchMetadataDependencies,
