...
import { ARTICLE_STATUSES, ARTICLE_URL_KINDS } from "./core/article";
import { METADATA_ERROR_CODES, METADATA_STATUSES } from "./core/metadata";
import { MAX_TAG_NAME_LENGTH, TAG_COLOR_HUE_COUNT } from "./core/tag";
...
export const techInboxSchema = { articles, articleUrls, tags, articleTags };
