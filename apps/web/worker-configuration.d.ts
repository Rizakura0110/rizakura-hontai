/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 0ae3e6e27cacad58784b8dacfffe9a78)
...
interface __BaseEnv_CloudflareBindings {
	...
	APP_ORIGIN: "https://tech-inbox-app.sx7k2p9q.workers.dev";
	TEAM_DOMAIN: string;
	POLICY_AUD: string;
