/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 3df160f047f5765efbd9310ba7e8f876)
...
interface __BaseEnv_CloudflareBindings {
	...
	APP_ORIGIN: "https://rizakura-hontai.sx7k2p9q.workers.dev";
	TEAM_DOMAIN: string;
	POLICY_AUD: string;
	ALLOWED_EMAIL: string;
	METADATA_FETCHER: Fetcher /* tech-inbox-metadata-fetcher */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "MAINTENANCE_MODE" | "APP_ORIGIN" | "TEAM_DOMAIN" | "POLICY_AUD" | "ALLOWED_EMAIL">> {}
}
